...
CS.FSMBase = {}
--[[
	@return [luaIde#CS.FSMBase]
]]
function CS.FSMBase() end
--[[
	@datas CS.System.Object{}
	@return [luaIde#CS.FSMBase]
]]
function CS.FSMBase(datas) end
--[[
	CS.System.String
	 Get 	 Set 
--]]
...
--[[
	@datas CS.System.Object{}
--]]
function CS.FSMBase:OnDataAnalysis(datas) end
--[[
	@datas CS.System.Object{}
--]]
function CS.FSMBase:OnEnter(datas) end
--[[
	@datas CS.System.Object{}
--]]
function CS.FSMBase:OnExit(datas) end
function CS.FSMBase:OnUpdate() end
function CS.FSMBase:OnFixedUpdate() end
function CS.FSMBase:OnLatedUpdate() end
--[[
	@other CS.UnityEngine.Collider
--]]
function CS.FSMBase:OnTriggerEnter(other) end
--[[
	@other CS.UnityEngine.Collider
--]]
function CS.FSMBase:OnTriggerStay(other) end
--[[
	@other CS.UnityEngine.Collider
--]]
...
--]]
function CS.FSMBase:OnCollisionEnter(other) end
--[[
	@other CS.UnityEngine.Collision
--]]
function CS.FSMBase:OnCollisionStay(other) end
--[[
	@other CS.UnityEngine.Collision
--]]
function CS.FSMBase:OnCollisionExit(other) end
function CS.FSMBase:OnDestroy() end
function CS.FSMBase:OnTransformChildrenChanged() end
function CS.FSMBase:OnTransformParentChanged() end
--[[
	@pauseStatus CS.System.Boolean
--]]
function CS.FSMBase:OnApplicationPause(pauseStatus) end
function CS.FSMBase:OnEnable() end
function CS.FSMBase:OnDisable() end
--[[
...
CS.PlayerStateBase = {}
--[[
	@return [luaIde#CS.PlayerStateBase]
]]
function CS.PlayerStateBase() end
--[[
	@datas CS.System.Object{}
	@return [luaIde#CS.PlayerStateBase]
]]
function CS.PlayerStateBase(datas) end
--[[
	CS.System.String
	 Get 
--]]
CS.PlayerStateBase.LayerName = nil
--[[
	CS.System.Single
	 Get 
--]]
CS.PlayerStateBase.CurrentAniLength = nil
--[[
	CS.System.Int32
	 Get 
--]]
CS.PlayerStateBase.CurrentLoopCount = nil
--[[
	CS.System.Single
	 Get 
--]]
CS.PlayerStateBase.CurrentLoopProgress = nil
--[[
	CS.System.Single
	 Get 
--]]
CS.PlayerStateBase.CurrentNormalizedTime = nil
--[[
	@RefType [luaIde#CS.UnityEngine.GameObject]
	 Get 	 Set 
--]]
CS.PlayerStateBase.owner = nil
--[[
	CS.UnityEngine.Animator
	 Get 	 Set 
--]]
CS.PlayerStateBase.ani = nil
--[[
	CS.UnityEngine.CharacterController
	 Get 	 Set 
--]]
CS.PlayerStateBase.cc = nil
--[[
	CS.System.String
	 Get 	 Set 
--]]
...
--[[
	@return [luaIde#CS.MLuaStateBehaviour]
]]
function CS.MLuaStateBehaviour() end
...
--@SuperType [luaIde#CS.UnityEngine.CustomYieldInstruction]
CS.UnityEngine.WWW = {}
--[[
...
--[[
	@url CS.System.String
	@postData CS.System.Byte{}
	@headers CS.System.Collections.Hashtable
	@return [luaIde#CS.UnityEngine.WWW]
]]
...
--[[
	CS.System.Boolean
	 Get 
--]]
CS.UnityEngine.WWW.keepWaiting = nil
--[[
...
--[[
	@url CS.System.String
	@cachedBundle CS.UnityEngine.CachedAssetBundle
	@crc CS.System.UInt32
	@return [luaIde#CS.UnityEngine.WWW]
--]]
function CS.UnityEngine.WWW:LoadFromCacheOrDownload(url,cachedBundle,crc) end

--@SuperType [luaIde#CS.BaseTestBase`1[[InnerTypeTest, Assembly-CSharp, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]]]
CS.BaseTest = {}
--[[
	@return [luaIde#CS.BaseTest]
]]
function CS.BaseTest() end
--[[
	@p CS.System.Int32
--]]
function CS.BaseTest:Foo(p) end
--[[
	@p CS.System.Int32
--]]
function CS.BaseTest:Proxy(p) end
function CS.BaseTest:ToString() end
...
--@SuperType [luaIde#CS.System.Object]
CS.Tutorial.PrivateOverrideClass = {}
--[[
	@return [luaIde#CS.Tutorial.PrivateOverrideClass]
]]
function CS.Tutorial.PrivateOverrideClass() end
--[[
	@i CS.System.Int32
--]]
function CS.Tutorial.PrivateOverrideClass:TestFunc(i) end
--[[
	@i CS.System.String
--]]
function CS.Tutorial.PrivateOverrideClass:TestFunc(i) end
--[[
	@i CS.System.Int32
--]]
function CS.Tutorial.PrivateOverrideClass:TestFunc3(i) end
--[[
	@i CS.System.String
--]]
function CS.Tutorial.PrivateOverrideClass:TestFunc2(i) end
