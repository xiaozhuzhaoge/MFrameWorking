...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(System.Collections.Generic.Dictionary<string, int>), SystemCollectionsGenericDictionary_2_SystemStringSystemInt32_Wrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(FSMBase), FSMBaseWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(PlayerStateBase), PlayerStateBaseWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(LuaState), LuaStateWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(LuaComponent), LuaComponentWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(MLuaStateBehaviour), MLuaStateBehaviourWrap.__Register);
